...
const loginPageCoverSvg = (
  ...
  >
    ...
    <path
      ...
      fill="#ccc"
    />
    <circle cx={524.99994} cy={335.5} r={16} fill="currentColor" />
    <polygon
  ...
  return (
    <div>
      <div className="grid md:grid-cols-2">
        <div className="bg-white h-[100vh] hidden md:flex justify-center items-center px-[3vw] text-primary">
          {loginPageCoverSvg}
        </div>

        <div className="bg-primary/8 min-h-[100vh] flex flex-col justify-center items-center px-[8vw]">
